...
description: >-
  ...
  failure; signals Orchestrator to re-run Tester. Targeted iteration, not cross-worktree investigation-only.
...
- Check `memory/operational_memory.md` at the repository root for known quirks, mocks, or prior failure patterns for this phase.
